...
function FilterDrawer({
  ...
  return (
    <>
      ...
      >
        <div className="flex items-center justify-between px-6 py-5 border-b border-nudepink-200">
          <h2 className="font-display text-lg text-espresso tracking-wide uppercase">Filter</h2>
        ...
        <div className="flex-1 overflow-y-auto px-6 divide-y divide-nudepink-200">
          {/* Category */}
          {categories.length > 0 && (
            <div className="py-6">
        ...
        <div className="p-6 border-t border-nudepink-200 flex gap-3">
          <button
            onClick={onClear}
            className="flex-1 py-3 rounded-full border border-nudepink-200 text-espresso text-sm font-medium hover:bg-blush-100 transition"
          >
            Clear
          </button>
          <button
            onClick={onApply}
            className="flex-1 py-3 rounded-full bg-espresso text-white text-sm font-medium hover:bg-rose-600 transition"
          >
            Apply
          </button>
        </div>
